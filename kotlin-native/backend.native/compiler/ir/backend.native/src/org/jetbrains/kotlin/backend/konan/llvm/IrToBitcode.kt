...
internal fun Context.gernerateRuntimeConstantsModule() : LLVMModuleRef {
    ...
    val static = ModuleStaticData(llvmModule, llvm.runtime.targetData)
    ...
    setRuntimeConstGlobal("KonanNeedDebugInfo", Int32(if (shouldContainDebugInfo()) 1 else 0))
